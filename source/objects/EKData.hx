...
class EKData
{
	public static var keysShit:Map<Int, Map<String, Dynamic>> = [
		...
		10 => [
			...
			"strumAnims" => [
				"LEFT", "DOWN", "UP", "RIGHT", "CIRCLE", "SPACE", "CIRCLE", "LEFT", "DOWN", "UP", "RIGHT"
			],
		...
		12 => [
			...
			"anims" => [
				"LEFT", "DOWN", "UP", "RIGHT", "LEFT", "DOWN", "UP", "UP", "RIGHT", "LEFT", "DOWN", "UP", "RIGHT"
			],
			"strumAnims" => [
				"LEFT", "DOWN", "UP", "RIGHT", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "LEFT", "DOWN", "UP", "RIGHT"
			],
		...
		13 => [
			...
			"anims" => [
				"LEFT", "DOWN", "UP", "RIGHT", "LEFT", "DOWN", "UP", "UP", "UP", "RIGHT", "LEFT", "DOWN", "UP", "RIGHT"
			],
			"strumAnims" => [
				"LEFT", "DOWN", "UP", "RIGHT", "CIRCLE", "CIRCLE", "SPACE", "CIRCLE", "CIRCLE", "CIRCLE", "LEFT", "DOWN", "UP", "RIGHT"
			],
		...
		14 => [
			...
			"anims" => [
				"LEFT", "DOWN", "UP", "RIGHT", "LEFT", "DOWN", "UP", "UP", "UP", "UP", "RIGHT", "LEFT", "DOWN", "UP", "RIGHT"
			],
			"strumAnims" => [
				"LEFT", "DOWN", "UP", "RIGHT", "CIRCLE", "CIRCLE", "SPACE", "CIRCLE", "SPACE", "CIRCLE", "CIRCLE", "LEFT", "DOWN", "UP", "RIGHT"
			],
		...
		15 => [
			...
			"anims" => [
				"LEFT", "DOWN", "UP", "RIGHT", "LEFT", "DOWN", "UP", "RIGHT", "LEFT", "DOWN", "UP", "RIGHT", "LEFT", "DOWN", "UP", "RIGHT"
			],
			"strumAnims" => [
				"LEFT", "DOWN", "UP", "RIGHT", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "LEFT", "DOWN", "UP", "RIGHT"
			],
			"pixelAnimIndex" => [0, 1, 2, 3, 9, 10, 11, 12, 14, 15, 16, 17, 5, 6, 7, 8]
		],
		16 => [
			"letters" => [
				"A", "B", "C", "D", "J", "K", "L", "M", "N", "O", "P", "Q", "R", "F", "G", "H", "I"
			],
			"anims" => [
				"LEFT", "DOWN", "UP", "RIGHT", "LEFT", "DOWN", "UP", "UP", "RIGHT", "LEFT", "DOWN", "UP", "RIGHT", "LEFT", "DOWN", "UP", "RIGHT"
			],
			"strumAnims" => [
				"LEFT", "DOWN", "UP", "RIGHT", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "CIRCLE", "LEFT", "DOWN", "UP",
				"RIGHT"
			],
...
class Keybinds
{
	...
	{
		return [
			['1 KEY'], ['Center', 'note_one1'], [''], ['2 KEYS'], ['Left', 'note_two1'], ['Right', 'note_two2'], [''], ['3 KEYS'], ['Left', 'note_three1'],
			['Center', 'note_three2'], ['Right', 'note_three3'], [''], ['4 KEYS'], ['Left', 'note_left'], ['Down', 'note_down'], ['Up', 'note_up'],
			['Right', 'note_right'], [''], ['5 KEYS'], ['Left', 'note_five1'], ['Down', 'note_five2'], ['Center', 'note_five3'], ['Up', 'note_five4'],
			['Right', 'note_five5'], [''], ['6 KEYS'], ['Left 1', 'note_six1'], ['Up', 'note_six2'], ['Right 1', 'note_six3'], ['Left 2', 'note_six4'],
			['Down', 'note_six5'], ['Right 2', 'note_six6'], [''], ['7 KEYS'], ['Left 1', 'note_seven1'], ['Up', 'note_seven2'], ['Right 1', 'note_seven3'],
			['Center', 'note_seven4'], ['Left 2', 'note_seven5'], ['Down', 'note_seven6'], ['Right 2', 'note_seven7'], [''], ['8 KEYS'],
			['Left 1', 'note_eight1'], ['Down 1', 'note_eight2'], ['Up 1', 'note_eight3'], ['Right 1', 'note_eight4'], ['Left 2', 'note_eight5'],
			['Down 2', 'note_eight6'], ['Up 2', 'note_eight7'], ['Right 2', 'note_eight8'], [''], ['9 KEYS'], ['Left 1', 'note_nine1'],
			['Down 1', 'note_nine2'], ['Up 1', 'note_nine3'], ['Right 1', 'note_nine4'], ['Center', 'note_nine5'], ['Left 2', 'note_nine6'],
			['Down 2', 'note_nine7'], ['Up 2', 'note_nine8'], ['Right 2', 'note_nine9'], [''], ['10 KEYS'], ['Left 1', 'note_ten1'], ['Down 1', 'note_ten2'],
			['Up 1', 'note_ten3'], ['Right 1', 'note_ten4'], ['Center 1', 'note_ten5'], ['Center 2', 'note_ten6'], ['Left 2', 'note_ten7'],
			['Down 2', 'note_ten8'], ['Up 2', 'note_ten9'], ['Right 2', 'note_ten10'], [''], ['11 KEYS'], ['Left 1', 'note_elev1'], ['Down 1', 'note_elev2'],
			['Up 1', 'note_elev3'], ['Right 1', 'note_elev4'], ['Left 2', 'note_elev5'], ['Center 2', 'note_elev6'], ['Right 2', 'note_elev7'],
			['Left 3', 'note_elev8'], ['Down 2', 'note_elev9'], ['Up 2', 'note_elev10'], ['Right 3', 'note_elev11'], [''], ['12 KEYS'],
			['Left 1', 'note_twel1'], ['Down 1', 'note_twel2'], ['Up 1', 'note_twel3'], ['Right 1', 'note_twel4'], ['Left 2', 'note_twel5'],
			['Down 2', 'note_twel6'], ['Up 2', 'note_twel7'], ['Right 2', 'note_twel8'], ['Left 3', 'note_twel9'], ['Down 3', 'note_twel10'],
			['Up 3', 'note_twel11'], ['Right 3', 'note_twel12'], [''], ['13 KEYS'], ['Left 1', 'note_thir1'], ['Down 1', 'note_thir2'],
			['Up 1', 'note_thir3'], ['Right 1', 'note_thir4'], ['Left 2', 'note_thir5'], ['Down 2', 'note_thir6'], ['Center', 'note_thir7'],
			['Up 2', 'note_thir8'], ['Right 2', 'note_thir9'], ['Left 3', 'note_thir10'], ['Down 3', 'note_thir11'], ['Up 3', 'note_thir12'],
			['Right 3', 'note_thir13'], ['14 KEYS'], ['Left 1', 'note_fourt1'], ['Down 1', 'note_fourt2'], ['Up 1', 'note_fourt3'],
			['Right 1', 'note_fourt4'], ['Left 2', 'note_fourt5'], ['Down 2', 'note_fourt6'], ['Center 1', 'note_fourt7'], ['Center 2', 'note_fourt8'],
			['Up 2', 'note_fourt9'], ['Right 2', 'note_fourt10'], ['Left 3', 'note_fourt11'], ['Down 3', 'note_fourt12'], ['Up 3', 'note_fourt13'],
			['Right 3', 'note_fourt14'], [''], ['15 KEYS'], ['Left 1', 'note_151'], ['Down 1', 'note_152'], ['Up 1', 'note_153'], ['Right 1', 'note_154'],
			['Left 2', 'note_155'], ['Down 2', 'note_156'], ['Center 1', 'note_157'], ['Center 2', 'note_158'], ['Center 3', 'note_159'],
			['Up 2', 'note_1510'], ['Right 2', 'note_1511'], ['Left 3', 'note_1512'], ['Down 3', 'note_1513'], ['Up 3', 'note_1514'],
			['Right 3', 'note_1515'], [''], ['16 KEYS'], ['Left 1', 'note_161'], ['Down 1', 'note_162'], ['Up 1', 'note_163'], ['Right 1', 'note_164'],
			['Left 2', 'note_165'], ['Down 2', 'note_166'], ['Up 2', 'note_167'], ['Right 2', 'note_168'], ['Left 3', 'note_169'], ['Down 3', 'note_1610'],
			['Up 3', 'note_1611'], ['Right 3', 'note_1612'], ['Left 4', 'note_1613'], ['Down 4', 'note_1614'], ['Up 4', 'note_1615'],
			['Right 4', 'note_1616'], [''], ['17 KEYS'], ['Left 1', 'note_171'], ['Down 1', 'note_172'], ['Up 1', 'note_173'], ['Right 1', 'note_174'],
			['Left 2', 'note_175'], ['Down 2', 'note_176'], ['Up 2', 'note_177'], ['Right 2', 'note_178'], ['Center', 'note_179'], ['Left 3', 'note_1710'],
			['Down 3', 'note_1711'], ['Up 3', 'note_1712'], ['Right 3', 'note_1713'], ['Left 4', 'note_1714'], ['Down 4', 'note_1715'], ['Up 4', 'note_1717'],
			['Right 4', 'note_1717'], [''], ['18 KEYS FINAL'], ['Left 1', 'note_181'], ['Down 1', 'note_182'], ['Up 1', 'note_183'], ['Right 1', 'note_184'],
			['Center 1', 'note_185'], ['Left 2', 'note_186'], ['Down 2', 'note_187'], ['Up 2', 'note_188'], ['Right 2', 'note_189'], ['Left 3', 'note_1810'],
			['Down 3', 'note_1811'], ['Up 3', 'note_1812'], ['Right 3', 'note_1813'], ['Center 2', 'note_1814'], ['Left 4', 'note_1815'],
			['Down 4', 'note_1816'], ['Up 4', 'note_1817'], ['Right 4', 'note_1818'], [''], ['UI'], ['Left', 'ui_left'], ['Down', 'ui_down'], ['Up', 'ui_up'],
			['Right', 'ui_right'], [''], ['Reset', 'reset'], ['Accept', 'accept'], ['Back', 'back'], ['Pause', 'pause'], [''], ['VOLUME'],
			['Mute', 'volume_mute'], ['Up', 'volume_up'], ['Down', 'volume_down'], [''], ['DEBUG'], ['Key 1', 'debug_1'], ['Key 2', 'debug_2']];
	}
